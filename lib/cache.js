 ...
 *                or false if serialised keys are used
 ...
 *         or as a name of the algorithm ('lru' and 'mru' are defined). By default 'lru' is used.
 */
function Cache(opts) {
    this.assoc = opts.assoc;
    this.size = opts.size;
    this.serialize = opts.serialize !== undefined || stableStringify;
