 ...
 *     algorythm: eviction algorythm, can be defined as an object that has three functions:
...
function Cache(opts) {
    ...
    var algo = opts.algorythm || opts.evict || 'lru';
    this.algorythm = typeof algo == 'string'
                      ? algorythms[algo]
                      : algo;
...
Cache.prototype.put = function Cache_put(key, value) {
    ...
    if (slotSet === undefined)
        slotSet = this.sets[id] = new SlotSet(this.assoc, this.algorythm);
